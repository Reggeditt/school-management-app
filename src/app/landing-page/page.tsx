    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-indigo-950">
      ...
      <header className="container mx-auto py-6 px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-6 items-center">
          <Link href="#features" className="text-gray-700 hover:text-indigo-600 dark:text-gray-300 dark:hover:text-indigo-400 transition-colors">
            Features
          </Link>
          <Link href="#testimonials" className="text-gray-700 hover:text-indigo-600 dark:text-gray-300 dark:hover:text-indigo-400 transition-colors">
            Testimonials
          </Link>
          <Link href="#pricing" className="text-gray-700 hover:text-indigo-600 dark:text-gray-300 dark:hover:text-indigo-400 transition-colors">
            Pricing
          </Link>
          <Link href="/login" className="text-gray-700 hover:text-indigo-600 dark:text-gray-300 dark:hover:text-indigo-400 transition-colors">
            Login
          </Link>
      ...
      <section className="container mx-auto px-4 py-20 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-10 md:mb-0">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">
            Transforming School Management for African Schools
          </h1>
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 mb-8">
            A comprehensive, all-in-one platform that streamlines administrative tasks, enhances learning experiences, and connects all stakeholders.
          </p>
        ...
        <div className="md:w-1/2 relative">
          <div className="w-full h-[400px] md:h-[500px] bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-2xl overflow-hidden relative">
            <div className="absolute inset-0 bg-white/10 backdrop-blur-sm rounded-2xl">
              <div className="absolute top-8 left-8 right-8 h-12 bg-white/20 rounded-lg backdrop-blur-md"></div>
              <div className="absolute top-28 left-8 w-40 h-40 bg-white/20 rounded-lg backdrop-blur-md"></div>
              <div className="absolute top-28 left-56 right-8 h-40 bg-white/20 rounded-lg backdrop-blur-md"></div>
              <div className="absolute top-76 left-8 right-8 bottom-8 bg-white/20 rounded-lg backdrop-blur-md"></div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
              Our platform offers a wide range of features designed to meet the needs of all school stakeholders.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Track attendance, manage profiles, and monitor academic progress with ease.",
                icon: (
              ...
              },
              {
                ...
                description: "Manage classes, assignments, and student performance analytics in one place.",
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {
                title: "Admin Panel",
                description: "Comprehensive tools for school oversight, analytics, and management.",
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {
                title: "Parent Portal",
                description: "Stay connected with your child's education, pay fees, and communicate with teachers.",
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                    <polyline points="9 22 9 12 15 12 15 22"></polyline>
              ...
              },
              {
                ...
                description: "Track fees, manage budgets, and handle payroll with our comprehensive financial tools.",
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              },
              {
                ...
                description: "Leverage AI for personalized learning, predictive analytics, and smart resource allocation.",
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <Card key={index} className="border-none shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white dark:bg-gray-800">
                <CardHeader>
                  <div className="w-16 h-16 rounded-full bg-indigo-100 dark:bg-indigo-900 flex items-center justify-center text-indigo-600 dark:text-indigo-400 mb-4">
                    {feature.icon}
                  </div>
      ...
      <section id="testimonials" className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
              Hear from schools across Africa that have transformed their operations with our platform.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                quote: "This system has revolutionized how we manage our school. The administrative burden has been reduced significantly, allowing us to focus more on education.",
                author: "Sarah Mensah",
                role: "Principal, Ghana International School",
              },
              {
                quote: "As a teacher, I can now easily track student performance, communicate with parents, and manage my classes all in one place. It's been a game-changer!",
                author: "Emmanuel Osei",
                role: "Teacher, Accra Academy",
              },
              {
                quote: "The parent portal has made it so much easier to stay involved in my children's education. I can track their progress, communicate with teachers, and pay fees online.",
                author: "Fatima Diallo",
                role: "Parent, Tema International School",
              },
            ].map((testimonial, index) => (
              <Card key={index} className="border-none shadow-lg bg-white dark:bg-gray-800">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <Button variant="outline" className="border-white text-white hover:bg-white hover:text-indigo-600 text-lg py-6 px-8">
              Schedule Demo
            </Button>
          </div>
        </div>
